...
function CompanyHighlightsSection() {
    return (
        <section className="bg-eggshell w-auto h-auto flex items-center py-8 lg:py-16">
            <div className="section-container flex flex-col lg:flex-row items-center md:justify-between justify-center w-full min-w-0 gap-6 md:gap-0">
                <h3 className="font-rajdhani font-bold text-carbon flex-shrink-0 text-center md:text-left">Empresas que inovaram <br />com a nossa
