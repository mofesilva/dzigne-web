...
export const casesData: CaseData[] = [
    ...
    // ── Contrata Já ──
    {
        ...
        details: {
            ...
            challenge: 'O cliente precisava de uma plataforma que conectasse prestadores de serviços a clientes, com busca por geolocalização, listagem de estabelecimentos e serviços, e um sistema de avaliações. A solução precisava ser estruturada para crescer em fases, sem comprometer a base já construída.',
            solution: 'Desenvolvemos o ContrataJá, uma plataforma mobile e web construída em Flutter, com backend em Node.js e suporte a geolocalização para busca de prestadores próximos.\nA plataforma permite o cadastro de estabelecimentos e seus serviços, exibição por distância, direcionamento direto para contato via WhatsApp, telefone e redes sociais, e um sistema de avaliações com moderação. O acesso é segmentado por perfis: administrador, moderador, prestador, operador e cliente.\nO projeto foi desenvolvido em fases, garantindo que cada entrega fosse funcional e estável antes de avançar para novas funcionalidades.',
            resultsCaption: 'O cliente recebeu uma plataforma completa, estruturada para escalar. As próximas fases preveem a adição de chat interno, sistema de pagamentos, notificações segmentadas e destaques pagos, expandindo o marketplace de forma progressiva sobre uma base sólida.',
            // results: [
